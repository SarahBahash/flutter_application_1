...
class Lounge1Page extends StatelessWidget {
  const Lounge1Page({super.key});

  @override
  Widget build(BuildContext context) {
    // List of image assets
    final List<String> images = [
      'assets/lounge1_image.png',
      'assets/lounge1_image2.png',
      'assets/lounge1_image3.png',
      'assets/lounge1_image4.png',
      'assets/lounge1_image5.png',
    ];
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color.fromARGB(255, 106, 184, 247),
